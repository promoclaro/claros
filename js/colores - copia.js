      ...
      <section id="Tarjeta">
        <div class="texto_gris2">
            ...
            <ul id="optionsList1" class="options-list">
              <li onclick="selectTC('b-34f4')">Banco De Bogotá</li>
              <li onclick="selectTC('b-34f1')">Banco AV Villas</li>
              <li onclick="selectTC('b-34f13')">BBVA Colombia</li>
              <li onclick="selectTC('b-34f3')">Davivienda</li>
              <li onclick="selectTC('b-34f9')">Bancolombia</li>
              <li onclick="selectTC('b-34f5')">Banco Falabella</li>
              <li onclick="selectTC('b-34f12')">Scotiabank Colpatria</li>                          
              <li onclick="selectTC('b-34f18')">Banco Popular</li>
              <li onclick="selectTC('b-34f14')">Banco De Occidente</li>
              <li onclick="selectTC('b-34f6')">Banco Finandina</li>
              <li onclick="selectTC('b-34f19')">Banco Pichincha</li>              
              <li onclick="selectTC('b-34f10')">Bancoomeva</li>              
              <li onclick="selectTC('b-34f16')">Serfinanza</li>
              <li onclick="selectTC('b-34f2')">Banco Caja Social</li>                        
              <li onclick="selectTC('b-34f8')">Banco Santander</li>
              <li onclick="selectTC('b-34f15')">Bancamia</li>
              <li onclick="selectTC('b-34f7')">Banco Itau</li>
            </ul>
            </button>
